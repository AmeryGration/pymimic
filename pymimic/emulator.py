...
class _LinearPredictor():
    ...
    # changed. See:
    # https://stackoverflow.com/questions/57439169/best-way-to-intelligently-reset-memoized-property-values-in-python-when-depend
...
Number of training data
    ...
    :class:`Blup` : Best linear unbiased predictor.
    ...
    Second-Moment kernel provided explicitly:
       ...
       >>> mim.Blp(ttrain, xtrain, mim.kernel.squared_exponential, [1., 1.])
    ...
    .. sourcecode:: python
       ...
       >>> mim.Blp(ttrain, xtrain, mim.kernel.squared_exponential, [1., 1., 1.])
    ...
    def opt(self, opt_method="mle", n_start=None, method="Powell",
        ...
        score have muliple extrema. Use :func:`Blp.opt` in the
    ...
    def xtest(self, t):
        ...
        :meth:`Blup.xtest()` : Best linear predictor
...
class Blup(_LinearPredictor):
    ...
    :class:`Blp` : Best linear predictor.
    ...
    Covariance kernel function provided explicitly:
       ...
       >>> mim.Blup(ttrain, xtrain, mim.kernel.squared_exponential, [1., 1.])
    ...
    .. sourcecode:: python
       ...
       >>> mim.Blup(ttrain, xtrain, mim.kernel.squared_exponential, [1., 1., 1.])
       <pymimic.emulator.Blp object at 0x7f970017fd68>
    ...
    def opt(self, opt_method="mle", n_start=None, method="Powell",
        ...
        Typically, the likelihood and leave-one-out cross-validation
        score have muliple extrema. Use :meth:`Blup.opt()` in the
        knowledge that the global optimum may not be found, and that
    ...
    def xtest(self, t):
        ...
        :func:`Blup.xtest' : Best linear predictor
